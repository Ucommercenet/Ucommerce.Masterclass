...
namespace Ucommerce.Masterclass.Umbraco.Api
{
    public class MasterClassAddressesController : UmbracoApiController
    {
        ...
        public MasterClassAddressesController(ITransactionClient transactionClient, IBasketIdResolver basketIdResolver, IPriceGroupIdResolver priceGroupIdResolver, ICultureCodeResolver cultureCodeResolver)
        {
